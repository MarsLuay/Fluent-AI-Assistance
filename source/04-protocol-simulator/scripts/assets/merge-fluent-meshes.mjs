...
const mergerPath = path.resolve(simulatorRoot, "../tools/simulator/merge_fluent_mesh_libraries.py");
...
for (const candidate of candidates) {
  const result = spawnSync(candidate.command, [...candidate.args, mergerPath, ...forwardedArgs], {
    cwd: simulatorRoot,
    stdio: "inherit",
    shell: false
  });
