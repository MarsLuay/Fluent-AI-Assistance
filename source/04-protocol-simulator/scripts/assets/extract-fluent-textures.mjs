...
const extractorPath = path.resolve(simulatorRoot, "../tools/simulator/extract_fluent_textures.py");
...
for (const candidate of candidates) {
  const result = spawnSync(candidate.command, [...candidate.args, extractorPath, ...forwardedArgs], {
    cwd: simulatorRoot,
    stdio: "inherit",
    shell: false
  });
