...
const builderPath = path.resolve(simulatorRoot, "../tools/simulator/build_procedural_fallback_specs.py");
...
for (const candidate of candidates) {
  const result = spawnSync(candidate.command, [...candidate.args, builderPath, ...forwardedArgs], {
    cwd: simulatorRoot,
    stdio: "inherit",
    shell: false
  });
