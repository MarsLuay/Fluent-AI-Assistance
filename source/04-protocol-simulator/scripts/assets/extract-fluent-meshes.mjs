...
const converterPath = path.resolve(simulatorRoot, "../tools/simulator/extract_fluent_meshes.py");
...
for (const candidate of candidates) {
  const result = spawnSync(candidate.command, [...candidate.args, converterPath, ...forwardedArgs], {
    cwd: simulatorRoot,
    stdio: "inherit",
    shell: false
  });
