...
_FIELD_TO_IR_KEY = {
    ...
    "PartialColumnOffset": "partial_column_offset_expression",
    "PartialRowsOffset": "partial_rows_offset_expression",
    "WellOffset": "well_offset_expression",
    "PositionFirstTip/X": "position_first_tip_x_expression",
    "PositionFirstTip/Y": "position_first_tip_y_expression",
    "FirstTipXPosition": "first_tip_x_position_expression",
    "FirstTipYPosition": "first_tip_y_position_expression",
    "LastTipXPosition": "last_tip_x_position_expression",
    "LastTipYPosition": "last_tip_y_position_expression",
    "Column": "column_expression",
    "Row": "row_expression",
    "RowOffset": "row_offset_expression",
    "ColumnOffset": "column_offset_expression",
    "OrientationPhi": "orientation_phi_expression",
    "OrientationPsi": "orientation_psi_expression",
    "OrientationTheta": "orientation_theta_expression",
}
...
def canonical_expression_command_id(command_id: str) -> str:
    ...
    checks = (
        ...
        ("Mca384PickUpTips", "Mca384PickUpTips"),
