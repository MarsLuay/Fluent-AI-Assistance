...
_CLI_COMMAND_COVERAGE: dict[str, dict[str, str]] = {
    ...
    "inspect": {"mode": "bridge", "note": "delegates to the shared input-inspection service"},
    ...
    "validate": {"mode": "bridge", "note": "delegates to the shared full-export readiness service"},
